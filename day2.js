...
// boolean datatype, result is 'true'
...
//array of values assigned to 'nums'

let nums = [1, 2, 3]
nums[0] = 10

//console.log(nums) == arrayed values || list of values 

console.log(nums) //console.log() == true !same array properties and values

/*
boolean value depends upon checking the variables:
must provide these checks
-same values && primitive datatype
-same index || data-length
-index-order of values must the same 
if these checks are met, boolean can be determines.
*/
...
let writingMaterials = ['Notebook','Pen', 'pencil', 'ruler']; //declare and assigned a list of txt strings : variable

/*
oh! I forgot to add 'Eraser' to the list of writing materials
but, it can still be added to the  array thru command : arrayName[index to hold the data value] = value;
*/



writingMaterials[4] = 'Eraser';

console.log(writingMaterials[4]);

//check for the boolean value of the variables index

console.log(nums.length == numbers.length);

// check for the boolean value of the corresponding index values 

console.log(nums[1] == numbers[1])
